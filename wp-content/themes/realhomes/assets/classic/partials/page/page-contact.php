                ...
                <div class="inner-wrapper">
                    ...
                    if ( 'true' === $show_contact_map ) { ?>
                        <div class="map-container clearfix">
                        	<?php get_template_part( 'assets/classic/partials/map/map', 'contact' ); ?>
                        </div>
                        <?php
                    }
                        ...
                        <section class="contact-details clearfix">
                            ...
                            <ul class="contacts-list">
                                ...
                                if ( ! empty( $contact_phone ) ) {
                                    ...
                                    ?><li class="phone"><?php include( INSPIRY_THEME_DIR . '/images/icon-phone.svg' ); esc_html_e( 'Phone', 'framework' ); ?> : <?php echo $desktop_version . $mobile_version; ?></li><?php
                                }
                                ...
                                if ( ! empty( $contact_cell ) ) {
                                    ...
                                    ?><li class="mobile"><?php include( INSPIRY_THEME_DIR . '/images/icon-mobile.svg' ); esc_html_e( 'Mobile', 'framework' ); ?> : <?php echo $desktop_version . $mobile_version; ?></li><?php
                                }

                                if ( ! empty( $contact_fax ) ) {
                                    ?><li class="fax"><?php include( INSPIRY_THEME_DIR . '/images/icon-printer.svg' ); esc_html_e( 'Fax', 'framework' ); ?> : <?php echo esc_html( $contact_fax ); ?></li><?php
                                }

                                if ( ! empty( $contact_display_email ) ) {
                                    ?><li class="email"><?php include( INSPIRY_THEME_DIR . '/images/icon-mail.svg' ); esc_html_e( 'Email', 'framework' ); ?> : <a href="mailto:<?php echo antispambot( $contact_display_email ); ?>"><?php echo antispambot( $contact_display_email ); ?></a></li><?php
                                }

                                if ( ! empty( $contact_address ) ) {
                                    ?><li class="address"><?php include( INSPIRY_THEME_DIR . '/images/icon-map.svg' ); esc_html_e( 'Address', 'framework' ); ?> : <?php echo esc_html( $contact_address ); ?></li><?php
                                }
                                ?>
                            </ul>
                        ...
                        if ( ! empty( $theme_contact_email ) ) {
                            ...
                            <section id="contact-form">
                                ...
                                <form class="contact-form" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                                    ...
                                    <p>
                                        <input type="submit" id="submit-button" value="<?php esc_attr_e( 'Send Message', 'framework' ); ?>" id="submit" class="real-btn" name="submit">
