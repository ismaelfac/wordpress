q<?php
/**
 * Single: Agent Head Card
 *
 * Head card for single agent template.
 *
 * @since 	3.0.0
 * @package RH/modern
 */
...
<div class="rh_agent_profile">
	...
	<div class="rh_agent_profile__wrap">
				...
				<div class="rh_agent_profile__contact">
					<?php if ( ! empty( $agent_office_phone ) ) : ?>
						<p class="detail office">
							<?php esc_html_e( 'Office', 'framework' ); ?>: <a href="tel:<?php echo esc_attr( $agent_office_phone ); ?>"><?php echo esc_html( $agent_office_phone ); ?></a>
						</p>
						<!-- /.detail -->
					<?php endif; ?>
					...
					<?php if ( ! empty( $agent_mobile ) ) : ?>
						<p class="detail mobile">
							<?php esc_html_e( 'Mobile', 'framework' ); ?>: <a href="tel:<?php echo esc_attr( $agent_mobile ); ?>"><?php echo esc_html( $agent_mobile ); ?></a>
						</p>
						<!-- /.detail -->
					<?php endif; ?>
					...
					<?php if ( ! empty( $agent_office_fax ) ) : ?>
						<p class="detail fax">
							<?php esc_html_e( 'Fax', 'framework' ); ?>: <a href="tel:<?php echo esc_attr( $agent_office_fax ); ?>"><?php echo esc_html( $agent_office_fax ); ?></a>
						</p>
						<!-- /.detail -->
					<?php endif; ?>
					...
					<?php if ( ! empty( $agent_whatsapp ) ) : ?>
						<p class="detail whatsapp">
							<?php esc_html_e( 'WhatsApp', 'framework' ); ?>: <a href="tel:<?php echo esc_attr( $agent_whatsapp ); ?>"><?php echo esc_html( $agent_whatsapp ); ?></a>
						</p>
						<!-- /.detail -->
					<?php endif; ?>
					...
					<?php if ( ! empty( $agent_email ) ) : ?>
						<p class="detail email">
							<?php esc_html_e( 'Email', 'framework' ); ?>: <a href="mailto:<?php echo esc_attr( antispambot( $agent_email ) ); ?>"><?php echo esc_html( antispambot( $agent_email ) ); ?></a>
						</p>
						<!-- /.detail -->
					<?php endif; ?>
				</div>
		...
		<div class="rh_agent_profile__contact_form">
			<?php get_template_part( 'assets/modern/partials/agent/contact/contact', 'form' ); ?>
		</div>
