...
<section class="rh_section rh_wrap rh_wrap--padding rh_wrap--topPadding">
	...
	<div class="rh_page">
		...
		<div class="rh_page__head">
			...
			<h2 class="rh_page__title">
				<?php if ( empty( $header_variation ) || ( 'none' === $header_variation ) ) : ?>
					<p class="sub"><?php echo esc_html( $banner_title ); ?></p>
					<!-- /.sub -->
				<?php endif; ?>
			    <p class="title"><?php echo esc_html( $banner_details ); ?></p>
			</h2>
			<!-- /.rh_page__title -->
		...
		<div class="rh_alert-wrapper rh_alert__404">
		    <h4 class="no-results"><?php esc_html_e( 'Please try using top navigation!', 'framework' ); ?></h4>
		</div>
