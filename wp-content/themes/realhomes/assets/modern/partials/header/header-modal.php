		...
		<?php if ( ! is_user_logged_in() ) : ?>
			...
			<div class="rh_modal__login_wrap modal">
				...
				<form id="rh_modal__login_form" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="POST" enctype="multipart/form-data">
					<input name="log" id="username" type="text" placeholder="<?php esc_attr_e( 'Username', 'framework' ); ?>" title="<?php esc_attr_e( '* Provide user name!', 'framework' ); ?>" required />
					...
					if ( inspiry_is_reCAPTCHA_configured()
			            ...
			            <?php
	                } elseif ( empty( get_option( 'inspiry_contact_form_shortcode' ) ) ) {
		            	?>
						<div class="rh_modal__recaptcha">
							<div class="inspiry-recaptcha-wrapper clearfix">
								<div class="inspiry-google-recaptcha"
				...
				<div class="switch">
					<a href="#" data-switch="forgot" id="rh-forgot-password"><?php esc_html_e( 'Forgot Password', 'framework' ); ?></a>
					<?php if ( get_option( 'users_can_register' ) ) : ?>
						<br />
						<a href="#" data-switch="register" id="rh-register"><?php esc_html_e( 'New User? Register Now', 'framework' ); ?></a>
					<?php endif; ?>
				</div>
				<!-- /.switch -->
			...
			<?php if ( get_option( 'users_can_register' ) ) : ?>
				...
				<div class="rh_modal__register_wrap modal">
					...
					<div class="switch">
						<a href="#" data-switch="login" id="rh-login"><?php esc_html_e( 'Login', 'framework' ); ?></a><br />
						<a href="#" data-switch="forgot" id="rh-forgot-password"><?php esc_html_e( 'Forgot Password', 'framework' ); ?></a>
					</div>
					<!-- /.switch -->
			...
			<div class="rh_modal__forgot_wrap modal">
				...
				<div class="switch">
					<a href="#" data-switch="login" id="rh-login"><?php esc_html_e( 'Login', 'framework' ); ?></a>
					<?php if ( get_option( 'users_can_register' ) ) : ?>
						<br />
						<a href="#" data-switch="register" id="rh-register"><?php esc_html_e( 'New User? Register Now', 'framework' ); ?></a>
					<?php endif; ?>
