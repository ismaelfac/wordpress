<?php
/**
 * View: Property List Map Card
 *
 * Property card for map listing view.
 *
 * @since 	3.0.0
 * @package RH/modern
 */
		...
		<figure class="rh_list_card__map_thumbnail">
		    ...
		    <div class="rh_list_card__btns">
	            ...
	            if ( ( 'enable' === $compare_properties_module ) && ( $inspiry_compare_page ) ) {
	                get_template_part( 'assets/modern/partials/property/compare/compare', 'button' );
	            }
		    	?>
		    </div>
		    <!-- /.rh_list_card__btns -->
			...
			<div class="rh_list_card__map_details">
				...
				<div class="rh_list_card__priceLabel">
					...
					<div class="rh_list_card__price">
						<h4 class="status">
							<?php display_figcaption( get_the_ID() ); ?>
						</h4>
						<!-- /.rh_prop_card__type -->
