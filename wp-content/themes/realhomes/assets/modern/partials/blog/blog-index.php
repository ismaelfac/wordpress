<?php
/**
 * Blog: Main Blog Posts Template
 *
 * Template for all blog posts.
 *
 * @since 	3.0.0
 * @package RH/modern
 */
			...
			<div class="rh_page__head">
				...
				<h2 class="rh_page__title">
				    ...
				    if ( ! empty( $banner_title ) && ( 1 < count( $banner_title ) ) ) {
				    	?>
				    	<p class="sub"><?php echo esc_html( $banner_title[0] ); ?></p>
				    	<p class="title"><?php echo esc_html( $banner_title[1] ); ?></p>
				    	<?php
				    } else {
				    	?>
				    	<p class="title"><?php echo esc_html( $banner_title[0] ); ?></p>
				    	<?php
				    }
					?>
				</h2>
