			...
			<?php if ( empty( $header_variation ) || ( 'none' === $header_variation ) ) : ?>
				<h2 class="rh_page__title">
					...
					if ( inspiry_is_edit_property() ) :
						?>
				    	<p class="sub"><?php esc_html_e( 'Edit' ); ?></p>
				    	<p class="title"><?php esc_html_e( 'Property' ); ?></p>
				    	<?php
					else :
						// Page Title.
			...
			if ( $invalid_nonce ) {
				...
				if ( $submitted_successfully ) {
					...
					if ( ! class_exists( 'IMS_Functions' ) ) {
						...
						if ( inspiry_is_edit_property() ) {
							get_template_part( 'assets/modern/partials/property/view/view', 'edit-property' );
						} else {
							get_template_part( 'assets/modern/partials/property/view/view', 'submit-property' );
